...
const DebitNotesView = () => {
  ...
  const accountName =
    debitNotesDetails?.bankDetails?.selectBank[0]?.accountName;
  const accountNumber =
            ...
            >
              <div className="row justify-content-center">
                <div className="col-lg-12">
                  <Middleware debitNotesDetails={debitNotesDetails} />
                </div>
              </div>
            </div>
          </div>
          {debitNotesDetails?.debitNotesDate && (
            <SendEmail
              endpoint={`/view-only-invoice/debitNotes/Debit-Notesforview/${id}`}
              defaultMail={debitNotesDetails?.name?.email}
            />
          )}
        </div>
      </div>
