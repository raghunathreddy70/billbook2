...
const CreditPending = ({ setDownloadData, toggleTabsState }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Link to={`/credit-notes-details/${record._id}`} className="invoice-link">
        <h2 className="table-avatar">{record.Credit}</h2>
      </Link>
      ),
    ...
    },
    {
      ...
      render: (text, record) => (
        <h2 className="table-avatar">
          <Link to={`/profile/${record._id}`} className="avatar avatar-sm me-2">
            <img
    ...
    },
    {
      ...
      render: (text, record) => (
        <Link to={`/credit-notes-details/${record._id}`}>
        <h2 className="table-avatar">{record.Amount}</h2>
      </Link>
      ),
    ...
    },
    {
      ...
      render: (text, record) => (
        <Link to={`/credit-notes-details/${record._id}`}>
        <h2 className="table-avatar">{record.Payment}</h2>
      </Link>
      ),
      ...
      render: (text, record) => (
        <>
          <div className="d-flex align-items-center">
            <button className="btn-action-icon me-2" onClick={() => handleIndividualDownload({ data: record })}>
            ...
            <div className="dropdown dropdown-action">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <ul>
                  ...
                  {/* <li>
                    <Link className="dropdown-item" to={`/credit-notes-details/${record._id}`}>
