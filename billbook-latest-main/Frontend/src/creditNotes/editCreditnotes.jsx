...
const EditCreditnotes = () => {
  ...
  console.log("formDatassdfsega", formData);
  ...
  const handleDateChange = (fieldName, date) => {
    if (date instanceof Date && !isNaN(date)) {
      ...
      if (fieldName === "creditnotesDate" && formData.creditnotesDate) {
        setFormData((prevData) => ({
          ...prevData,
          [fieldName]: isoDate,
          dueDate: "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${backendUrl}/api/creditNotes/update-creditNotes/${id}`,
        { formData }
      );
  ...
  useEffect(() => {
    const fetchCreditnotesDetails = async (id) => {
      try {
        const response = await fetch(
          `${backendUrl}/api/creditNotes/creditNotes/${id}`
        );
        if (response.ok) {
          const creditNotesDetails = await response.json();

          if (creditNotesDetails?.table.length > 0) {
            setProductsSelected(true);
          }
          setFormData(creditNotesDetails);
        } else {
          ...
          <div className="content container-fluid">
            <div className="page-header">
              <div className="content-page-header justify-normal items-center space-x-2">
                <BackButton />
                <h5 className="mt-0">Edit Credit Notes</h5>
              </div>
            </div>
            <div className="row">
                    ...
                    <div className="form-group-item border-0 mb-0">
                      <div className="row align-item-center">
                        <PanCardNumber
                          ...
                          handleShandleSubmit={handleSubmit}
                        />
                        {/* </Modal> */}
                        <div className="col-lg-4 col-md-6 col-sm-12">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              value={formData.creditnotesNumber}
                              readOnly
                            />
                          </div>
                        </div>
                          ...
                          <div className="form-group">
                            ...
                            <div className="cal-icon cal-icon-info">
                              <DatePicker
                                ...
                                selected={new Date(formData.creditnotesDate)}
                                onChange={(date) =>
                          ...
                          <div className="form-group">
                            ...
                            <div className="cal-icon cal-icon-info">
                              <DatePicker
                                ...
                                minDate={new Date(formData.creditnotesDate)}
                                dateFormat="dd-MM-yyyy"
                                showTimeInput={false}
                              ></DatePicker>
                            </div>
