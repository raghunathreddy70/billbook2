...
const AddInvoiceBackup = () => {
  ...
  const validateFormData = (formData) => {
    ...
    if (!formData.referenceNo) {
      validationErrors.referenceNo = false;
      console.error('Please enter a reference number');
    }

    if (!formData.website) {
      validationErrors.website = { isValid: false, message: 'please enter a website details' };
      console.error('Please enter a wesite ');
    }
    // Check if the bank has been selected
    if (!formData.bankDetails.selectBank && !bankSelected) {
      validationErrors.bankSelected = { isValid: false, message: 'Please select a bank' };
      console.error('Please select a bank');
    }
    if (!formData.products && !productsSelected) {
      validationErrors.productsSelected = { isValid: false, message: 'Please select products' };
  ...
  const handlewebsiteChange = (fieldName, value) => {
    let isValid = true;
    let message = '';
    const wesiteRegex = /^(https?:\/\/)?(www\.)?([a-zA-Z0-9_-]+\.)*[a-zA-Z]{2,}(\.[a-zA-Z]{2,})?(\/[^\s]*)?$/;
    if (fieldName === 'website') {
      isValid = wesiteRegex.test(value);
                            ...
                            <ul className="form-group-plus css-equal-heights">
                              <li>
                                ...
                                {!validation.customerName && (
                                  <p className="error-message text-danger">Please select a customer</p>
                                )}
                              </li>
                          ...
                          <div className="form-group">
                            ...
                            <div className="cal-icon cal-icon-info">
                              ...
                              {/* {validation.dueDate === false && (
                                <div className="error-message text-danger">Please select a dueDate</div>
                              )} */}
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-12">
                          <div className="form-group">
                            ...
                            {!validation.referenceNo && (
                              <div className="error-message text-danger">please enter reference number</div>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                          <div className="form-group">
                            ...
                            {!validation.website.isValid && (
                              <div className="error-message text-danger">{validation.website.message}</div>
                            )}
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="col-xl-6 col-lg-12">
                          <div className="form-group-bank">
                            <div className="form-group">
                              ...
                              onClick={() => setProductsSelected(true)}  // Set productsSelected to true when the link is clicked
                            >
                              <center>Select Products</center>
                                ...
                                <Link
                                  ...
                                  onClick={() => {
                                    setProductsSelected(true); // Reset productsSelected when opening the modal
                                  }}
                                >
                                  <center>Select Products</center>
                                </Link>
                                {validation.productsSelected && !productsSelected && (
        ...
        >
          <div className="modal-dialog modal-dialog-centered modal-md">
            <div className="modal-content">
              <div className="modal-header border-0 pb-0">
                <div className="form-header modal-header-title text-start mb-0">
                  <h4 className="modal-title mb-0">Add Product Details</h4>
                </div>
                <button
                  type="button"
                  className="close"
...
export default AddInvoiceBackup;
