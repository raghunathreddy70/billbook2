...
const InvoicePaid = ({
  ...
  useEffect(() => {
    if (datasourcePaid || filteredDatasourcePaid) {
      const paidInvoices = datasourcePaid.filter(
  ...
  }, [datasourcePaid, filteredDatasourcePaid]);
  ...
  return (
    <>
      ...
      <div className="modal custom-modal fade" id="delete_modal1" role="dialog">
