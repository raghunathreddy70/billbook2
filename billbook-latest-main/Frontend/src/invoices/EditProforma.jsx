  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:8000/api/performa/update-performa/${id}`,
        { formData }
      );
      ...
      toast.success("Performa submitted Succesfully", {
    ...
    const fetchProformaDetails = async (id) => {
      try {
        const response = await fetch(
          `http://localhost:8000/api/performa/performadetails/${id}`
        );
        if (response.ok) {
          const proformaDetails = await response.json();
          setFormData(proformaDetails);
          // if (proformaDetails?.totalTaxPercentage !== 0) {
          //   setIsGstEnabled(true)
          // }
          if (proformaDetails?.table.length > 0) {
          ...
          <div className="content container-fluid">
            <div className="page-header">
              <div className="content-page-header justify-normal items-center space-x-2">
                <BackButton />
                <h5 className="mt-0">Edit Proforma</h5>
              </div>
            </div>
            <div className="row">
                    ...
                    <div className="form-group-item border-0 mb-0">
                      <div className="row align-item-center">
                        <PanCardNumber
                          ...
                          handleSubmitProforma={handleSubmit}
                        />
                        {/* </Modal> */}
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                          <div className="form-group">
                            <label>Proforma Date<span className="text-danger">*</span></label>
                            <div className="cal-icon cal-icon-info">
                              <DatePicker
                                className="datetimepicker form-control"
                                selected={new Date(formData.performaDate)}
                                onChange={(date) =>
                          ...
                          <div className="form-group">
                            ...
                            <div className="cal-icon cal-icon-info">
                              <DatePicker
                                ...
                                minDate={new Date(formData.performaDate)}
                                dateFormat="dd-MM-yyyy"
                                showTimeInput={false}
                              ></DatePicker>
