...
const VenPanCard = ({venpancardmodalOpen,
    onCancel,
    setVenPancardmodalOpen,
    name,
    handleSubmit,
    isCustomerPan,
    isBusinessPan}) => {
  ...
  const handleSubmitPanNumber = async (e) => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:8000/api/addPurchases/updateVenPanNumber/${name}`,
        formData
      );
