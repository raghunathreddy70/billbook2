...
const EditInvoice = () => {
  ...
  const fetchInvoiceDetails = async (id) => {
    try {
      const response = await axios.get(
        `http://localhost:8000/api/addInvoice/invoicesdetails/${id}`
      );
      let data = response.data;
      // if (data?.totalTaxPercentage !== 0) {
                    ...
                    <div className="form-group-item border-0 mb-0">
                      <div className="row align-item-center">
                        <PanCardNumber
                          ...
                          customerName={formData?.customerName?._id}
                          ...
                          <div className="form-group">
                            ...
                            <div className="cal-icon cal-icon-info">
                              ...
                              <DatePicker
                                ...
                                minDate={new Date(formData.invoiceDate)}
                                dateFormat="dd-MM-yyyy"
                                showTimeInput={false}
                              ></DatePicker>
                            </div>
                    ...
                    <div className="form-group-item border-0 p-0">
                      <div className="row">
                        <div className="col-xl-6 col-lg-12">
                          <div className="form-group-bank">
                            <div className="form-group">
                              {formData?.bankDetails?.selectBank?.length >
                                0 && (
                                  <div className="add-bank-details mt-3">
                                    {console.log(
                                      "formData?.bankDetails?.selectBank?.length",
                                      formData?.bankDetails?.selectBank[0]
                                    )}
