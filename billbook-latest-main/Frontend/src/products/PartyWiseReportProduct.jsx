...
const PartyWiseReportProduct = ({ productid }) => {
...
console.log("customers", customers)
  ...
  // useEffect(() => {
    const fetchProductReportDetails = async (productid) => {
      try {
        const response = await axios.get(
          `http://localhost:8000/api/addProduct/productReportbycustomer/${productid}`
        );
  ...
  console.log("datasourcegodownreport", datasource);
