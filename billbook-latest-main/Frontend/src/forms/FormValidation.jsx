                                                ...
                                                <form className="needs-validation" noValidate>
                                                    <div className="form-row row">
                                                        ...
                                                        <div className="col-md-4 mb-3">
                                                            ...
                                                            <div className="input-group">
                                                                ...
                                                                <div className="error-message text-danger"> Please choose a username.</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="form-row row">
                                                        <div className="col-md-6 mb-3">
                                                            ...
                                                            <div className="error-message text-danger">Please provide a valid city.</div>
                                                        </div>
                                                        <div className="col-md-3 mb-3">
                                                            <label htmlFor="validationCustom04">State</label>
                                                            <input type="text" className="form-control" id="validationCustom04" placeholder="State" required />
                                                            <div className="error-message text-danger">Please provide a valid state.</div>
                                                        </div>
                                                        <div className="col-md-3 mb-3">
                                                            <label htmlFor="validationCustom05">Zip</label>
                                                            <input type="text" className="form-control" id="validationCustom05" placeholder="Zip" required />
                                                            <div className="error-message text-danger">Please provide a valid zip.</div>
                                                        </div>
                                                    </div>
                                                    <div className="form-group">
                                                        <div className="form-check">
                                                            ...
                                                            <div className="error-message text-danger">You must agree before submitting.</div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="col-sm">
                                                <form className="was-validated">
                                                    <div className="mb-3">
                                                        ...
                                                        <div className="error-message text-danger">Please enter a message in the textarea.</div>
                                                    </div>
                                                    <div className="form-check mb-3">
                                                        ...
                                                        <div className="error-message text-danger">Example invalid feedback text</div>
                                                    </div>
                                                    <div className="form-check">
                                                    ...
                                                    <div className="form-check mb-3">
                                                        ...
                                                        <div className="error-message text-danger"> More example invalid feedback text</div>
                                                    </div>
                                                    <div className="mb-3">
                                                        ...
                                                        <div className="error-message text-danger">Example invalid select feedback</div>
                                                    </div>
                                                    <div className="mb-3">
                                                        <input type="file" className="form-control" aria-label="file example" required />
                                                        <div className="error-message text-danger">Example invalid form file feedback</div>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
