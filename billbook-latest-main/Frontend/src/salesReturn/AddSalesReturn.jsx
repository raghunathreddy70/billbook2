...
const AddSalesReturn = () => {
  ...
  useEffect(() => {
    axios
      .get(`${backendUrl}/api/SalesReturn/salesReturn/${userData?.data?._id}`)
      .then((response) => {
  ...
  const handlePaymentTermsChange = (terms) => {
    ...
    const moonLanding = new Date(formData.salesReturnDate).getTime();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        ` ${backendUrl}/api/SalesReturn/salesReturn`,
          ...
          <div className="content container-fluid">
            <div className="page-header">
              <div className="content-page-header justify-normal items-center space-x-2">
                <BackButton />
                <h5 className="mt-0">Create Sales Return</h5>
              </div>
            </div>
            <div className="row">
                  ...
                  <div className="card-body pt-4">
                    <div className="form-group-item border-0 mb-0">
                      <div className="row align-item-center">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                          <div className="form-group">
                            <label>SalesReturn Date</label>
                            <div className="cal-icon cal-icon-info">
                              <DatePicker
                                className="datetimepicker form-control"
                                selected={formData.salesReturnDate}
                                onChange={(date) =>
