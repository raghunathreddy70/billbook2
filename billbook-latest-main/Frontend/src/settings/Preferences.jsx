                  ...
                  <form>
                    ...
                    <label className="row form-group toggle-switch">
                      ...
                      <span className="col-8 col-sm-9 toggle-switch-content ml-0">
                        ...
                        <span className="d-block text-muted Discount-PerItem">
                          Enable this if you want to add Discount to individual
                          invoice items. By default, Discount is added directly
                          to the invoice.
                        </span>
                      </span>
                    </label>
