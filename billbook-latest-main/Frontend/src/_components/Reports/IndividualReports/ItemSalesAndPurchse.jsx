...
const ItemSalesAndPurchse = () => {
  ...
  const [selectedDateVar, setSelectedDateVar] = useState("itemName");
    ...
    const fetchData = async (page) => {
      try {
        ...
        const response = await axios.get(
          `${backendUrl}/api/addProduct/products/${userData?.data?._id}?page=${page}&pageSize=10`
        );
  ...
  console.log("datasourcesdvzsdcA", datasource)
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a, b) => a.salesProduct.length - b.salesProduct.length,
    },
    {
      title: "Purchase Quantity",
      dataIndex: "purchaseProduct",
      sorter: (a, b) => a.purchaseProduct.length - b.purchaseProduct.length,
    },
  ];
        ...
        <div className="page-header">
          <div className="content-page-header">
            <div className='d-flex align-items-start'>
              <BackButton />
              <h5 className='reports-h5'>Item Sales And Purchase Summary</h5>
            </div>
...
export default ItemSalesAndPurchse