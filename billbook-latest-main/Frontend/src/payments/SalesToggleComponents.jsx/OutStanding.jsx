...
const OutStanding = ({ active, setActive }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (balance, record) => {
                if (balance.length > 0) {
                    const lastPayment = balance[balance.length - 1];
            ...
            sorter: (a, b) => {
                const lastBalanceA =
                    a.balance.length > 0 ? a.balance[a.balance.length - 1].balance : 0;
                const lastBalanceB =
                    b.balance.length > 0 ? b.balance[b.balance.length - 1].balance : 0;
