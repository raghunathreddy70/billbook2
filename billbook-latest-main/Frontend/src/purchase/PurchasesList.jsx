...
import PurchaseListHeader from "../purchase/PurchaseListHeader";
...
const PurchaseList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => {
        const formattedDate = new Date(record.Last).toLocaleDateString(
          "en-GB",
          {
            year: "numeric",
            month: "2-digit",
                ...
                <div className="row align-items-center">
                  <div className="col-lg-12">
                    <div className="invoices-tabs">
                      <ul>
                        <li>
                          <Link to="/purchases-list" className="active">
                            All Invoice
                          </Link>
                        </li>
                        <li>
                          <Link to="/purchaselist-paid">Paid</Link>
                        </li>
                        <li>
                          <Link to="/purchaselist-overdue" >Overdue</Link>
                        </li>
                        <li>
                          <Link to="/purchaselist-outstanding">Outstanding</Link>
                        </li>
