...
const PurchaseOrderCards = ({ invoiceGrandTotal, allInvoicelength, totalPaidAmount, paidAmountLength, totalOutstandingAmount, outStandingLength }) => {
    return (
        <>
